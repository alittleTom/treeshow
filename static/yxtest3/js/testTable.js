    ...
    $("#querylist").bootstrapTable({
           ...
           columns:[{
               ...
               title:'对应的需求'
                ...
                var s = '<a class = "save" href="javascript:void(0)">新增脚本</a>';
...
window.operateEvents = {
    'click .save': function (e, value, row, index) {
        var test_name=row['name']
        var test_id=row['id']
        window.location.href=window.document.location.href+"script/add/?test_name="+test_name + "&"+ "test_id="+test_id
    },

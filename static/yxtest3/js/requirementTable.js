    ...
    $("#querylist").bootstrapTable({
           ...
           columns:[{
               ...
               title:'创建时间'
                ...
                var s = '<a class = "save" href="javascript:void(0)">新增测试</a>';
...
window.operateEvents = {
    'click .save': function (e, value, row, index) {
        var requirement_id=row['id']
        var requirement_name=row['name']
        window.location.href=window.document.location.href+"test/add/?requirement_id="+requirement_id +'&'+"requirement_name="+requirement_name
    },
...
function addrequirement() {
    window.location.href=window.document.location.href+"add"
}
